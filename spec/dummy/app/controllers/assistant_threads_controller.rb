class AssistantThreadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @assistant_thread.save
        format.html { redirect_to assistant_thread_url(@assistant_thread), notice: "AssistantThread was successfully created." }
      else
  ...
  def update
    respond_to do |format|
      if @assistant_thread.save
        format.html { redirect_to assistant_thread_url(@assistant_thread), notice: "AssistantThread was successfully updated." }
      else
